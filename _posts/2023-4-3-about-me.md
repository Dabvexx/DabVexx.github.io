...
# Bio
Hello, I'm Alex Woods. I am a creative and passionate developer with a love for games and learning what makes them work.
...
I am proficient in C# and Unity. I have dipped my toes in other C languages (see [this post](/blog/project-vexxed-renderer) to read about my C++ OpenGL renderer!) C# is what really taught me to program beyond simple toy programs. 

I also like experimenting with blender to learn how better to use it. check [this post](/blog/DungeonModel) for a scene of a dungeon, and [this post](not implimented) to see my first ever rigged model!

I have also been working on my own home network, using various tools and services in proxmox to make it run. check out [this post](/blog/home-lab) to see more.
