...
<div align="center">
    <img src="..\assets\images\9-15-2024ProxmoxState.png" alt="Proxmox State" width = "33%">
</div>
...
I use TrueNAS Scale on the R330 as a file storage server, mainly as a secondary backup and to store large files that are impractical to store on my PC. Currently with only 8GB of RAM it can barely manage this task, but once I upgrade the server I plan to migrate many CasaOS containers to TrueNAS Scale as well as having redundant infrastructure of Caddy, Pi-Hole, and Wire Guard.